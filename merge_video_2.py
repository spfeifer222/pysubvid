...
my_parser.add_argument('pattern',
                       metavar='pattern',
                       type=str,
                       help='Pattern to identify the episode, e.g. S01E01 match all files containing this string.\nNote: This pattern must match all video files (and if PROCESS_SRT=True the srt file, too) make this script working correctly.')
...
my_parser.add_argument('-n',
                       '--name',
                       help='Name of the episode title to use in OUTPUTFILE. If no name is given, the format S<series No>E<episode No> is used.')
...
my_parser.add_argument('-s',
                       ...
                       default=False,
                       dest='PROCESS_SRT',
                       help='Set PROCESS_SRT=True in order to rocess srt subtile (default: False.)')
